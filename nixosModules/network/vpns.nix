...
in
{
  ...
  config = {
    ...
    systemd =
      ...
      in
      {
        services.wireguard-autostart =
          mkIf (cfg.windscribe.wireguard.hostileNetworks && cfg.windscribe.wireguard.autoStart)
            {
              unitConfig = {
        ...
        network = mkIf wgcfg.enable {
          ...
          networks = {
            "50-wg0" = {
              ...
              linkConfig.ActivationPolicy = mkIf (
                cfg.windscribe.wireguard.hostileNetworks || !cfg.windscribe.wireguard.autoStart
              ) "down";
